...
func TestRenderDeploymentGuideIncludesInstructionsAndCredentials(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"- Pre-generated stream service ID: `",
		"- Pre-generated stream webhook token: `",
		...
		"- Use the shared application `auth_secret` below for publisher/viewer JWT validation",
		"- Keep `dave_allow_av1: false`",
		"- Rendered starter config: `",
		"stream_config.yaml`",
		"gochat-deployer tokens stream --secret",
		"git checkout v1.2.3",
